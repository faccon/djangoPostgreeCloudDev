...
def write_learners():
    ...
    learner_david.save()
    learner_john = Learner(first_name='Babatunde', last_name='Adebiyi', dob=date(1995, 1, 16),
                           occupation='developer',
                           social_link='https://www.linkedin.com/babs/')
    learner_john.save()
    learner_john = Learner(first_name='BABS', last_name='DEVS', dob=date(1986, 3, 16),
                           occupation='developer',
                           social_link='https://www.linkedin.com/devs/')
    learner_john.save()
